...
<section class="product_section layout_padding-bottom ">
    <div class="container" style="margin-top: 200px;">
        ...
        <ul class="filters_menu wow fadeInUp">
            ...
            <li data-filter=".Heels & Sandal">Heels Ans Sandal</li>
            <li data-filter=".Boote & Shoes">Boote And Shoes</li>
            <li data-filter=".Flats ">Flats </li>
            <li data-filter=".Sneaker & Billies">Sneaker And Billies</li>
        </ul>
