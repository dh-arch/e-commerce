                ...
                <div class="col-md-8">
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <a class="btn btn-info profileedit">Edit Profile</a>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                <div class="col-sm-3">
                                    <h6 class="mb-0 pt-2" style="display: flex; align-content: center;">Change Password</h6>
                                </div>
                                <div class="col-sm-9 text-secondary" style="display: flex; justify-content: end;">
                                    <a class="btn btn-info passwordedit">Edit Password</a>
                                </div>
                            </div>
                            ...
                            <div class="card h-100">
                                <div class="card-body">
                                    ...
                                    <div class="profile-data">
                                        <p class="wishlist"><i class="fa fa-heart " aria-hidden="true" style="font-size: 16px;"></i> &nbsp;&nbsp; Wishlist Products </p>
                                        <p class="addtocart"><i class="fa fa-cart-shopping " aria-hidden="true"></i> &nbsp;&nbsp; addtocart Products </p>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
    $(document).ready(function() {
        $('.profileedit').click(function() {
            window.location.href = 'http://localhost/feane-1.0.0/profileedit.php';
        })

        $('.passwordedit').click(function() {
            window.location.href = 'http://localhost/feane-1.0.0/passwordedit.php';
        })
