...
<section class="product_section layout_padding-bottom ">
    <div class="container" style="margin-top: 200px;">
        ...
        <ul class="filters_menu wow fadeInUp">
            ...
            <li data-filter=".Jewellery Sets">Jewellery Sets</li>
            <li data-filter=".Rings">Rings</li>
            <li data-filter=".Necklaces & Chains">Necklaces And Chains</li>
            <li data-filter=".Earrings">Earrings</li>
            <li data-filter=".Bracelets & Bangles">Bracelets And Bangles</li>
        </ul>
