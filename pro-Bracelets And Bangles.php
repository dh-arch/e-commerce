...
// print_r(urldecode($_GET['subcategory']));
?>
...
<div class="container category my-5" style="padding : 50px 0px; ">
    ...
    <div class="row">
        ...
        WHERE admin_category.category='jewellery'";

        // $sql = "SELECT admin_subcategory.subcategory, admin_subcategory.image FROM admin_subcategory
        // WHERE admin_subcategory.subcategory='$subcategory' ";
        // print_r($sql);
