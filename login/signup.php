...
<body>
    ...
    <!-- signin form -->
    <!-- <div class=" none grid justify-items-stretch justify-items-center items-center h-[100%] w-[100%] fixed z-10 top-0 overflow-y-hidden bg-white wow animate__animated animate__fadeIn "
        id="signupform" >
        <div class="fixed grid justify-items-stretch justify-self-center" >
            ...
            <form class="grid justify-items-stretch" id="signup" data-parsley-validate>
                <div class="my-4 form-input border-b-2 border-slate-600 w-72 focus:border-none">
                    <p id='errormess' class='text-red-800 text-md'></p>
                    <input class="px-2 form-control focus:outline-none " type="text" id="fname" name="fname" placeholder="enter firstname">
                </div>

                <div class="my-4 form-input border-b-2 border-slate-600 w-72 focus:border-none">
                    <p id='errormess' class='text-red-800 text-md'></p>
                    <input class="px-2 form-control focus:outline-none" type="text" id="lname" name="lname" placeholder="enter lastname">
                </div>

                <div class="my-4 form-input border-b-2 border-slate-600 w-72 focus:border-none">
                    <p id='errormess' class='text-red-800 text-md'></p>
                    <input class="px-2 form-control focus:outline-none" type="email" id="email" name="email" placeholder="enter email">
                </div>

                <div class="my-4 form-input border-b-2 border-slate-600 w-72 focus:border-none">
                    <p id='errormess' class='text-red-800 text-md'></p>
                    <input class="px-2 form-control focus:outline-none" type="text" id="mobileno" name="mobileno" placeholder="enter mobileno">
                </div>

                <div class="my-4 form-input border-b-2 border-slate-600 w-72 focus:border-none">
                    <p id='errormess' class='text-red-800 text-md'></p>
                    <input class="px-2 form-control focus:outline-none" type="password" id="pwd" name="password" placeholder="enter password">
                </div>

                <button id="signupbutton" name="signup"
                    class="justify-self-center px-10 py-2 mt-3 text-white rounded bg-orange-400 hover:translate-y-2">signup
                </button>

                <div class="mt-3 justify-self-center">
                    <span>already have an account?</span>
                    <a href="#login" class="cursor-pointer text-orange-400 text-md " id="loginbutton">login now</a>
                </div>
            </form>
        </div>
    </div> -->
    ...
    <script>
        $(document).ready(function(){
            ...
            //     if(fname == ''){
            //         $('errormess').html('firstname is required');
            //     }
            //     else-if(lname == ''){
            //         $('errormess').html('lastname is required');
            //     }
            //     else-if(email == ''){
            //         $('errormess').html('email is required');
            //     }
            //     else-if(mobileno == ''){
            //         $('errormess').html('mobileno is required');
            //     }
            //     else-if(password == ''){
