                            ...
                            <div class="profile-head">
                                <div class="photo-content">
                                    ...
                                    <div class="profile-photo">
                                        <img src="<?= BASE_URL ?>assets/images/profile/profile.png" class="img-fluid rounded-circle" alt="">
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="profile-news mt-4 pb-3">
                                    ...
                                    <div class="media pt-3 pb-3">
                                        <img src="<?= BASE_URL ?>assets/images/profile/5.jpg" alt="image" class="mr-3">
                                    ...
                                    <div class="media pt-3 pb-3">
                                        <img src="<?= BASE_URL ?>assets/images/profile/6.jpg" alt="image" class="mr-3">
                                        <div class="media-body">
                                            <h5 class="m-b-5">John Tomas</h5>
                                            <p>I shared this on my fb wall a few months back, and I thought I'd share it here again because it's such a great read</p>
                                        </div>
                                    ...
                                    <div class="media pt-3 pb-3">
                                        <img src="<?= BASE_URL ?>assets/images/profile/7.jpg" alt="image" class="mr-3">
                                        <div class="media-body">
                                            <h5 class="m-b-5">John Tomas</h5>
                                            <p>I shared this on my fb wall a few months back, and I thought I'd share it here again because it's such a great read</p>
                                        </div>
                                            ...
                                            <div id="my-posts" class="tab-pane fade active show">
                                                <div class="my-post-content pt-3">
                                                    ...
                                                    <div class="profile-uoloaded-post border-bottom-1 pb-5">
                                                        <img src="<?= BASE_URL ?>assets/images/profile/8.jpg" alt="" class="img-fluid">
                                                    ...
                                                    <div class="profile-uoloaded-post border-bottom-1 pb-5">
                                                        <img src="<?= BASE_URL ?>assets/images/profile/9.jpg" alt="" class="img-fluid">
                                                        <a class="post-title" href="javascript:void()">
                                                            <h4>Collection of textile samples lay spread</h4>
                                                        </a>
                                                        <p>A wonderful serenity has take possession of my entire soul like these sweet morning of spare which enjoy whole heart.A wonderful serenity has take possession of my entire soul like these sweet morning
