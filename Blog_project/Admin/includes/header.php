...
<head>
    ...
    <!-- Favicon icon -->
    <link type="image/png" sizes="16x16" href="<?= BASE_URL ?>assets/images/favicon.png" rel="icon">
    <!-- Datatable -->
    <link href="<?= BASE_URL ?>assets/vendor/datatables/css/jquery.dataTables.min.css" rel="stylesheet">
    <link href="<?= BASE_URL ?>assets/vendor/owl-carousel/css/owl.carousel.min.css" rel="stylesheet">
    <link href="<?= BASE_URL ?>assets/vendor/owl-carousel/css/owl.theme.default.min.css" rel="stylesheet">
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a href="<?= BASE_URL ?>controller/Login.php?type=logout" class="dropdown-item">
                                        <i class="icon-key"></i>
