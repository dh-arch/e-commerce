                ...
                <div class="row">
                        ...
                        <div class="card">
                            <div class="stat-widget-two card-body">
                                <div class="stat-content">
                                    ...
                                    ?>
                                    <div class="stat-digit"> <?php print_r($totalproduct); ?> </div>
                                </div>
                                <div class="progress">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card">
                            <div class="stat-widget-two card-body">
                                <div class="stat-content">
                                    <div class="stat-text"> All Pending Orders </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card">
                            <div class="stat-widget-two card-body">
                                <div class="stat-content">
                                    <div class="stat-text"> All Completed Orders </div>
                        ...
                        <div class="card">
                            <div class="card-body text-center">
                                ...
                                <ul class="widget-line-list m-b-15">
                                    ...
                                    <li>8% <br><span class="text-danger"><i class="ti-hand-point-down"></i>Negative</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                                        ...
                                        <div class="item">
                                            <div class="testimonial-content">
                                                ...
                                                <div class="media">
                                                    ...
                                                    <img class="testimonial-author-img ml-3" src="<?= BASE_URL ?>assets/images/avatar/1.png"
                                                        alt="" />
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <table class="table mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="round-img">
                                                        <a href=""><img width="35" src="<?= BASE_URL ?>assets/images/avatar/1.png" alt=""></a>
                                                    </div>
                                                </td>
                                                <td>Lew Shawon</td>
