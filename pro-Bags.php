...
<section class="product_section layout_padding-bottom ">
    <div class="container" style="margin-top: 200px;">
        ...
        <ul class="filters_menu wow fadeInUp">
            ...
            <li data-filter=".Sling Bag">Sling Bag</li>
            <li data-filter=".Clutch">Clutch</li>
            <li data-filter=".Wallets">Wallets</li>
            <li data-filter=".Hand Bag">Hand Bag</li>
            <li data-filter=".Backpack Bag">Backpack Bag</li>
        </ul>
